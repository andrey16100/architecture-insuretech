...
### Проблемы с производительностью:
 ...
 - Время самого медленного ответа становится минимальным временем работы сервиса.
...
### Надёжность:
 ...
 - Данные между сервисами core-app и ins-comp-settlement могут расходиться со временем.
...
### Введение Event Bus - Apache Kafka:
 - Используем симантику доставки сообщений At Least Once для того чтобы гаранитровать доставку.
...
- Также данный паттерн можно применить при доставке сообщений сервисам core-app и ins-comp-settlement о продуктах и тарифах, чтобы исключить расхождение данной информации внутри этих сервисов.  
